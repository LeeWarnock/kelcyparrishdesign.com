	        ...
	        switch (n) {
	            case 'thundercodes_button':
	                var c = cm.createSplitButton('thundercodes_button', {
	                    title : 'ThunderCodes',
	                    image : '../wp-content/themes/longwave/functions/thundercodes/thunder_icon.png',
	                ...
	                c.onRenderMenu.add(function(c, m) {
	                    ...
	                    m.add({title : 'Latest Projects', onclick : function() {
	                    	tinyMCE.activeEditor.execCommand('mceInsertContent', 0, '[latest_projects title="YOUR_TITLE" cat_slugs="CATEGORY_SLUGS" number=4]');
	                    }});
	                    
	                    m.add({title : 'Portfolio', onclick : function() {
	                    	tinyMCE.activeEditor.execCommand('mceInsertContent', 0, '[portfolio title="YOUR_TITLE" cat_slugs="CATEGORY_SLUGS" number=12 subline="CATEGORIES or TAGS" type="slider"]');
	                    }});
